...
class CoinremitterTxn extends BaseTxn
{
    ...
    public function deposit()
    {
        ...
        $param = [
            ...
            'notify_url' => route('ipn.coinremitter'), // optional,url on which you wants to receive notification,
            'fail_url' => route('status.cancel', ['reftrn' => Crypt::encryptString($this->txn)]), // optional,url on which user will be redirect if user cancel invoice,
            'suceess_url' => route('status.success', ['reftrn' => Crypt::encryptString($this->txn)]), // optional,url on which user will be redirect when invoice paid,
            'name' => '', // optional,
