...
class EmandateTest extends TestCase
{
    ...
    {
        $data = $this->api->customer->create(['name' => 'Razorpay User 71', 'email' => 'customer71@razorpay.com', 'contact' => 9999999999, 'fail_existing' => '0']);
    ...
    {
        $data = $this->api->order->create(['amount' => 100, 'currency' => 'INR', 'method' => 'emandate', 'customer_id' => $this->customerId, 'receipt' => 'Receipt No. '.time(), 'notes' => ['notes_key_1' => 'Beam me up Scotty', 'notes_key_2' => 'Engage'], 'token' => ['auth_type' => 'netbanking', 'max_amount' => 9999900, 'expire_at' => 4102444799, 'notes' => ['notes_key_1' => 'Tea, Earl Grey, Hot', 'notes_key_2' => 'Tea, Earl Grey… decaf.'], 'bank_account' => ['beneficiary_name' => 'Gaurav Kumar', 'account_number' => '1121431121541121', 'account_type' => 'savings', 'ifsc_code' => 'HDFC0000001']]]);
