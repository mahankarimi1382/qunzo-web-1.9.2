...
class CoverageTest extends TestCase
{
     ...
     */
    public function test_token_coverage()
    {
     ...
     */
    public function test_account_coverage()
    {
     ...
     */
    public function test_stakeholder_coverage()
    {
     ...
     */
    public function test_product_coverage()
    {
     ...
     */
    public function test_webhook_coverage()
    {
     ...
     */
    public function test_api_instance()
    {
     ...
     */
    public function test_plan_coverage()
    {
     ...
     */
    public function test_qr_code_coverage()
    {
     ...
     */
    public function test_refund_coverage()
    {
     ...
     */
    public function test_subscription_coverage()
    {
     ...
     */
    public function test_virtual_account_coverage()
    {
     ...
     * @covers \Razorpay\Api\Addon::fetchAll
     */
    public function test_addon_coverage()
    {
        $addon = new AddonTest;
        $addon->setUp();
     ...
     */
    public function test_customer_coverage()
    {
     ...
     */
    public function test_card_coverage()
    {
        $card = new CardTest;
        $card->setup();
        $card->testFetchCard();
     ...
     */
    public function test_fund_coverage()
    {
        $fund = new FundTest;
        $fund->setup();
     ...
     */
    public function test_invoice_coverage()
    {
     ...
     */
    public function test_item_coverage()
    {
        $item = new ItemTest;
        $item->setup();
        $item->testcreate();
     ...
     */
    public function test_order_coverage()
    {
     ...
     */
    public function test_payment_coverage()
    {
     ...
     */
    public function test_paymentlink_coverage()
    {
     ...
     */
    public function test_settlement_coverage()
    {
     ...
     * @covers \Razorpay\Api\Transfer::all
     */
    public function test_transfer_coverage()
    {
     ...
     */
    public function test_utility_coverage()
    {
