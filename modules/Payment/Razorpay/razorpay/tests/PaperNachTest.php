...
class PaperNachTest extends TestCase
{
     ...
     * Create customer
     */
    public function test_create_customer_paper_nach()
    {
        $data = $this->api->customer->create(['name' => 'Razorpay User 72', 'email' => 'customer72@razorpay.com', 'fail_existing' => '0']);
     ...
     * Create Order
     */
    public function test_create_order_paper_nach()
    {
     ...
     */
    public function test_registration_link()
    {
     ...
     */
    public function test_fetch_payment_byorder_id()
    {
     ...
     */
    public function test_create_order_charge()
    {
     ...
     */
    public function test_create_recurring()
    {
