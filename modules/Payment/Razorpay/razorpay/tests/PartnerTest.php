...
class PartnerTest extends TestCase
{
    ...
    public function test_create_stakerholder()
    {
    ...
    public function test_fetch_stakerholder()
    {
    ...
    public function test_fetch_all_stakerholder()
    {
    ...
    public function test_edit_stakerholder()
    {
    ...
    public function test_product_configuration()
    {
    ...
    public function test_fetch_tnc()
    {
    ...
    public function test_webhook_fetch()
    {
    ...
    public function test_fetch_all_webhook()
    {
    ...
    public function test_fetch_account()
    {
