...
class BitwaspBitcoinMinimalBranchTest extends TestCase
{
    ...
    public function test_public_keys(): void
    {
    ...
    public function test_p2_wpkh_over_p2_sh_address(): void
    {
    ...
    public function test_p2_wpkh_address(): void
    {
    ...
    public function test_p2_sh_address(): void
    {
    ...
    public function test_p2_wsh_over_p2_sh_address(): void
    {
    ...
    public function test_witness_v0_address(): void
    {
    ...
    public function test_p2_pkh_address(): void
    {
    ...
    public function test_transaction_p2_sh_to_p2_wsh_over_p2_sh(): void
    {
    ...
    public function test_transaction_p2_wsh_over_p2_s_hto_p2_wpkh(): void
    {
    ...
    public function test_transaction_p2_wpkh_to_witness_v0(): void
    {
    ...
    public function test_tranasction_witness_v0_to_p2_wpkh_over_p2_sh(): void
    {
    ...
    public function test_transaction_p2_wpkh_over_p2_sh_to_p2_pkh(): void
    {
    ...
    public function test_transaction_p2_pkh_to_p2_sh(): void
    {
