                    ...
                    <div class="profile-card">
                        <div class="top">
                            ...
                            <div class="title-des">
                                ...
                                <p>{{ __('AID') }}: <strong>{{ $user->account_number }}</strong></p>
                            ...
                            <div class="btns">
                                @can('agent-send-mail')
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#sendEmail">
                                        <a href="javascript:void(0);" class="site-btn-round blue-btn" data-bs-toggle="tooltip"
                                            data-bs-original-title="{{ __('Send Email') }}">
                                            <i data-lucide="mail"></i>
                                        </a>
                                    </button>
                                @endcan
                                @can('agent-balance-add-or-subtract')
                                ...
                                @can('agent-delete')
                                    <a href="#" class="site-btn-round red-btn" id="deleteModal" data-bs-toggle="modal"
                                        data-bs-target="#delete" title="{{ __('Delete User') }}"><i data-lucide="trash-2"></i></a>
                        ...
                        @can('agent-all-type-status')
                            <!-- User Status Update -->
                            @include('backend.agent.include.__status_update')
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="data-card">
                                ...
                                <div class="content">
                                    <h4><span class="count">{{ $statistics['total_cash_received'] }}</span> </h4>
                                    <p>{{ __('Total Cash Received') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="data-card">
                                ...
                                <div class="content">
                                    <h4 class="count">{{ $statistics['total_cashin'] }}</h4>
                                    <p>{{ __('Total Cash In') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="site-tab-bars">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            @canany(['agent-basic-manage', 'agent-change-password'])
                            ...
                            @can('transaction-list')
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('admin.agent.edit', ['id' => $agent->id, 'tab' => 'transactions']) }}"
                            ...
                            @canany(['support-ticket-list', 'support-ticket-action'])
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('admin.agent.edit', ['id' => $agent->id, 'tab' => 'ticket']) }}"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <!-- basic Info -->
                        @canany(['agent-basic-manage', 'agent-change-password'])
                            @include('backend.agent.include.__basic_info')
                        @endcanany
