...
@section('auth-content')
    <div class="login">
        ...
        <div class="login-content">
            <div class="logo">
                <a href="#"><img src="{{ asset(setting('site_logo', 'global')) }}"
            ...
            <div class="auth-body">
                <form action="{{ route('admin.reset.password.submit') }}" method="post">
                    ...
                    <div class="single-box">
                        <label for="" class="box-label">{{ __('New Password') }}</label>
                    ...
                    <div class="single-box">
                        <label for="" class="box-label">{{ __('Confirm Password') }}</label>
                        <input type="password" name="password_confirmation" class="box-input" placeholder="{{ __('Confirm Password') }}"
                            required />
                    ...
                    <div class="single-box">
                        <button class="site-btn primary-btn" type="submit">{{ __('Reset Password Now') }}</button>
                    </div>
                </form>
            </div>
        </div>
