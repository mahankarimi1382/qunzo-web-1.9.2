                    ...
                    <div class="site-tab-bars">
                        <ul>
                            ...
                            @can('withdraw-method-manage')
                                <li
                                    class="{{ isActive('admin.withdraw.method.list', 'auto') . isActive('admin.withdraw.method.create', 'auto') . isActive('admin.withdraw.method.edit', 'auto') }}">
                                    <a href="{{ route('admin.withdraw.method.list', 'auto') }}"><i
                                            data-lucide="banknote"></i>{{ __('Automatic Method') }}</a>
                                </li>

                                <li
                                    class="{{ isActive('admin.withdraw.method.list', 'manual') . isActive('admin.withdraw.method.create', 'manual') . isActive('admin.withdraw.method.edit', 'manual') }}">
