            ...
            <div class="site-card">
                ...
                <div class="site-card-body">
                    <div class="theme-img">
                        ...
                        @endif
                        <img class="w-100" src="{{ asset('backend/materials/theme/' . $theme->name . '.jpg') }}"
                            alt="">
                    </div>
                    @if ($theme->status)
                        <a href="#" class="site-btn w-100 centered mt-4 disabled"><i
                                data-lucide="circle-check"></i>{{ __('Activated') }}</a>
                    @else
                        <a href="{{ route('admin.theme.status-update', ['id' => $theme->id]) }}"
                            class="site-btn black-btn w-100 centered mt-4"><i
                                data-lucide="check"></i>{{ __('Active Now') }}</a>
                    @endif
