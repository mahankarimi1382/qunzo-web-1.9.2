                            ...
                            <div class="site-card-body">
                                <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                <label for="" class="box-input-label">
                                                    {{ __('Username:') }}
                                                    @if (getPageSetting('username_validation'))
                                    ...
                                    @if (getPageSetting('country_show'))
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                <label for="" class="box-input-label">{{ __('Country:') }}
                                                    @if (getPageSetting('country_validation'))
                                                        <span class="text-danger">*</span>
                                                    @endif
                                                </label>
                                    ...
                                    @if (getPageSetting('gender_show'))
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                <label for="" class="box-input-label">
                                                    {{ __('Gender:') }}
                                                    @if (getPageSetting('gender_validation'))
                                                        <span class="text-danger">*</span>
                                                    @endif
                                                </label>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="site-input-groups">
                                            <label for=""
                                                class="box-input-label">{{ __('Email Address:') }}</label>
                                    ...
                                    @if (getPageSetting('phone_show'))
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                <label for="" class="box-input-label">{{ __('Phone:') }}
                                                    @if (getPageSetting('phone_validation'))
                                                        <span class="text-danger">*</span>
                                                    @endif
                                                </label>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="site-input-groups">
                                            <label for=""
                                                class="box-input-label">{{ __('Date of Birth:') }}</label>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="site-input-groups">
                                            ...
                                            <input type="password" name="password" class="box-input mb-0"
                                                    ...
                                                    @foreach (json_decode($kyc->fields, true) as $key => $field)
                                                        ...
                                                        @elseif($field['type'] == 'textarea')
                                                            <div class="site-input-groups">
                                                                ...
                                                                <textarea type="text" @if ($field['validation'] == 'required') required @endif
                                                                    name="kyc_credential[{{ $kyc->id }}][{{ $field['name'] }}]" class="box-input mb-0"> </textarea>
                                                            </div>
                                                        @else
                                                            <div class="site-input-groups">
                                                                <label for=""
