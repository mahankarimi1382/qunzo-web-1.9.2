                        ...
                        <div class="col-xl-12">
                            <div class="site-input-groups mb-0">
                                ...
                                <select class="form-select" name="wallet_type" id="wallet" required>
                                    <option value="default" data-currency="{{ setting('site_currency', 'global') }}">
                                        {{ __('Main Wallet') }} ({{ setting('site_currency', 'global') }})
                                    </option>
                                    @foreach ($user->wallets as $wallet)
                                        <option data-currency="{{ $wallet->currency->code }}"
                                            value="{{ $wallet->id }}">
                        ...
                        <div class="col-xl-12">
                            <div class="site-input-groups">
                                ...
                                <div class="input-group joint-input">
                                    <span
                                        class="input-group-text balance-add-sub-currency">{{ setting('site_currency', 'global') }}</span>
