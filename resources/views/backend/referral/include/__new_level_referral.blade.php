<div class="modal fade" id="addNewReferral" tabindex="-1" aria-labelledby="addNewLevelModalLabel" aria-hidden="true">
                ...
                <form method="post" action="{{ route('admin.referral.store') }}">
                    ...
                    <div class="popup-body-text">
                        ...
                        <div class="action-btns">
                            ...
                            <a href="javascript:;" class="site-btn-sm red-btn" data-bs-dismiss="modal"
                                aria-label="Close">
                                <i data-lucide="x"></i>
                                {{ __('Close') }}
                            </a>
