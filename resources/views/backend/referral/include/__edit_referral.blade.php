<div class="modal fade" id="editReferral" tabindex="-1" aria-labelledby="addNewLevelModalLabel" aria-hidden="true">
                    ...
                    <div class="popup-body-text">
                        ...
                        <div class="site-input-groups">
                            ...
                            <div class="input-group joint-input">
                                <input type="text" class="form-control target-amount" name="target_amount"
                        ...
                        <div class="site-input-groups">
                            ...
                            <div class="input-group joint-input">
                                <input type="text" class="form-control bounty" name="bounty"
                                    oninput="this.value = validateDouble(this.value)">
                        ...
                        <div class="site-input-groups mb-0">
                            ...
                            <textarea name="description" class="form-textarea description" placeholder="{{ __('Description') }}"></textarea>
                        </div>
