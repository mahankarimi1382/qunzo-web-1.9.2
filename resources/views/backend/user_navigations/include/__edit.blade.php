        ...
        <div class="modal-content site-table-modal">
            <div class="modal-body popup-body">
                ...
                <div class="popup-body-text">
                    <form action="{{ route('admin.user.navigation.update','id') }}" method="POST" id="edit-form">
                        @csrf
                        ...
                        <div class="site-input-groups">
                            ...
                            <input type="text" name="name" class="box-input mb-0 name" placeholder="{{ __('Menu Name') }}" required/>
                        </div>
