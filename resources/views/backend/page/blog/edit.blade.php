                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            ...
                            <a href="{{ route('admin.page.edit', 'blog') }}" class="title-btn" type="button"><i
                                    data-lucide="layout-list"></i>{{ __('Blog Section') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.blog.update', $blog['id']) }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Blog Title') }}<i
                                ...
                                <div class="site-input-groups row mb-0">
                                    <label for="" class="col-sm-3 col-label">{{ __('Blog Details') }}<i
                                            data-lucide="info" data-bs-toggle="tooltip" title=""
                                            data-bs-original-title="There will be blog title"></i></label>
                                    <div class="col-sm-9">
                                        <div class="site-input-groups fw-normal">
                                            <div class="site-editor">
                                                <textarea class="summernote" name="details">{!! $blog['details'] !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
