            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ route('admin.page.blog.create') }}" class="card-header-link">{{ __('Add New') }}</a>
                    </div>
                </div>
                <div class="site-card-body">
                        ...
                        <table id="dataTable" class="display data-table">
                            ...
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr>
                                        <td>
                                            <img class="avatar" src="{{ asset($post->cover) }}"
                                                alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.page.blog.edit', $post->locale_id) }}"
                                                class="round-icon-btn primary-btn" data-bs-toggle="tooltip"
                                                data-bs-original-title="Edit Blog">
                                                <i data-lucide="edit-3"></i>
                                            </a>
                                            <button class="round-icon-btn red-btn deleteBlog" type="button"
