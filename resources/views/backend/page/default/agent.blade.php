...
@section('content')
    <div class="main-content">
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="page_code" value="agent">
        ...
        @php
            $landingContent = getLandingContents('agent');
        @endphp
        <div class="site-card">
            <div class="site-card-header">
                <h3 class="title">{{ __('Contents') }}</h3>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.default.section.include.__add_new_agent_content')
