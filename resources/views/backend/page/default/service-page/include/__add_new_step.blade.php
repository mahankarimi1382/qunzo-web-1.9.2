<div class="modal fade" id="addNewStep" tabindex="-1" aria-labelledby="addNewStepModalLabel" aria-hidden="true">
        ...
        <div class="modal-content site-table-modal">
            <div class="modal-body popup-body">
                ...
                <div class="popup-body-text">
                    <h3 class="title mb-4">{{ __('Add New Step') }}</h3>
                    <form action="{{ route('admin.page.content-store') }}" method="post">
                        @csrf
                        <input type="hidden" name="type" value="service-{{ $code }}-steps">
