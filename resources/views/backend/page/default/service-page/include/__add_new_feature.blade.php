<div class="modal fade" id="addNewFeature" tabindex="-1" aria-labelledby="addNewFeatureModalLabel" aria-hidden="true">
                ...
                <div class="popup-body-text">
                    ...
                    <form action="{{ route('admin.page.content-store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="site-input-groups mb-0">
                            ...
                            <textarea name="description" class="form-textarea" placeholder="{{ __('Description') }}"></textarea>
                        </div>
