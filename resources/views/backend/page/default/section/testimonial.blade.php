...
@section('content')
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="testimonial">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($testimonials as $content)
                                <tr>
                                    <td>
                                        <img class="avatar avatar-round" src="{{ asset($content->picture) }}"
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.default.section.include.__add_new_testimonial')
    ...
    <!-- Modal for Delete  -->
    @include('backend.page.default.section.include.__delete_testimonial')
