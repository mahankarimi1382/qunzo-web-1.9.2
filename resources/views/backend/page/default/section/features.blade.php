...
@section('content')
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="features">
                                ...
                                @endif
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Features Title') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Features Subtitle') }}</label>
                                    <div class="col-sm-9">
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.default.section.include.__add_new_feature')
