<div class="modal fade" id="addNewHowItWorks" tabindex="-1" aria-labelledby="addNewHowItWorksModalLabel" aria-hidden="true">
            ...
            <div class="modal-body popup-body">
                ...
                <div class="popup-body-text">
                    ...
                    <form action="{{ route('admin.page.content-store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="type" value="mobile-recharge-how-it-works">

                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Icon') }}</label>
                            <div class="wrap-custom-file">
                                <input type="file" name="icon" id="howitworks_icon"
                                    accept=".gif, .jpg, .png, .svg, .webp" />
                                <label for="howitworks_icon">
