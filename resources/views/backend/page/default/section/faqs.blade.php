...
@section('content')
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @endif
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Faq Title') }}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Faq Subtitle') }}</label>
                                    <div class="col-sm-9">
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.default.section.include.__add_new_faq')
