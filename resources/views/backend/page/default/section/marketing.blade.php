                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="marketing">
                                ...
                                {{-- Merchant  --}}
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Merchant Title') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="merchant_title" class="box-input"
                                            value="{{ $data->merchant_title }}">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Merchant Subtitle') }}</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="merchant_subtitle" class="box-input"
                                            value="{{ $data->merchant_subtitle }}">
                                    </div>
                                </div>
                                @if ($key == 'en')
                                    <div class="site-input-groups row">
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="merchant_image" id="merchant_image"
                                                    accept=".gif, .jpg, .png, .svg, .webp" />
                                                <label for="merchant_image" id="merchant_image"
                                                    @if ($data->merchant_image) class="file-ok"
                                                   style="background-image: url({{ asset($data->merchant_image) }})" @endif>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    ...
                                                    <input type="text" name="merchant_button_label" class="box-input"
                                                        value="{{ $data->merchant_button_label }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    ...
                                                    <div class="site-input-groups">
                                                        <div class="site-input-groups">
                                                            <input type="text" name="merchant_button_url" class="box-input"
                                                                value="{{ $data->merchant_button_url }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    ...
                                                    <div class="site-input-groups">
                                                        <select name="merchant_button_target" class="form-select">
                                                            <option @if ($data->merchant_button_target == '_self') selected @endif
                                                                value="_self">{{ __('Same Tab') }}</option>
                                                            <option @if ($data->merchant_button_target == '_blank') selected @endif
                                ...
                                @if ($key == 'en')
                                    <div class="site-input-groups row">
                                        ...
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="agent_image" id="agentImage"
                                                    accept=".gif, .jpg, .png, .svg, .webp" />
                                                <label for="agentImage" id="agentImage"
                                                    @if ($data->agent_image) class="file-ok"
                                                   style="background-image: url({{ asset($data->agent_image) }})" @endif>
                                                    <img class="upload-icon"
