...
@section('content')
    <div class="main-content">
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="page_code" value="p2p-trading">
                                ...
                                <div class="site-input-groups row mt-4">
                                    <label
                                        class="col-sm-12 col-label fw-bold">{{ __('About P2P Exchange Section') }}</label>
                                </div>
                                <div class="site-input-groups row">
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Features Button') }}</label>
                                    <div class="col-sm-9">
                                        <div class="form-row">
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    <label for=""
                                                        class="box-input-label">{{ __('Button Label') }}</label>
                                                    <input type="text" name="features_button_label" class="box-input"
                                                        value="{{ $data->features_button_label }}">
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    <label for=""
                                                        class="box-input-label">{{ __('Button URL') }}</label>
                                                    <input type="text" name="features_button_url" class="box-input"
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="site-input-groups">
                                                    <label for=""
                                                        class="box-input-label">{{ __('Target') }}</label>
                                                    <select name="features_button_target" class="form-select">
                                                        <option @if ($data->features_button_target == '_self') selected @endif
                                                            value="_self">{{ __('Same Tab') }}</option>
                                                        <option @if ($data->features_button_target == '_blank') selected @endif
                                                            value="_blank">{{ __('Open In New Tab') }}</option>
                                                    </select>
                                                </div>
                                            </div>
        ...
        @php
            $howItWorksContent = getLandingContents('p2p-trading-how-it-works');
            $featuresContent = getLandingContents('p2p-trading-features');
            $faqsContent = getLandingContents('p2p-trading-faqs');
        @endphp
    ...
    @include('backend.page.default.section.include.__add_new_p2p_trading_howitworks')
    <!-- Modal for Add New How It Works End -->

    <!-- Modal for Add New Feature -->
    @include('backend.page.default.section.include.__add_new_p2p_trading_feature')
    <!-- Modal for Add New Feature End -->

    <!-- Modal for Add New FAQ -->
    @include('backend.page.default.section.include.__add_new_p2p_trading_faq')
