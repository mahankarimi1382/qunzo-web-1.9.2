                    ...
                    <div class="site-card overflow-hidden">
                        ...
                        <div class="site-card-body">
                            <div class="support-ticket-single-message user">
                                <div class="logo">
                                    @if ($ticket->user->avatar_path !== null)
                                        <img class="avatar avatar-round" src="{{ $ticket->user->avatar_path }}"
                                            alt="" height="40" width="40">
                                    @else
                                        <span class="avatar-text">{{ $ticket->user->first_name[0] }}
                                            ...
                                            @foreach ($attachments as $attachment)
                                                <div class="attach">
                                                    <a href="{{ asset($attachment) }}" target="_blank"><i
                                                            class="anticon anticon-picture"></i>{{ getBasename($attachment) }}
                                                    </a>
                                                </div>
                                            @endforeach
                                        </div>
                            ...
                            @foreach ($ticket->messages as $message)
                                <div
                                    ...
                                    <div class="logo">
                                        @if ($message->model != 'admin')
                                            <img class="avatar avatar-round"
                                                src="{{ asset($ticket->sender->avatar ?? 'global/materials/user.png') }}"
                                                alt="" height="40" width="40">
                                        @else
                                            <img class="avatar avatar-round"
                                                src="{{ asset($message->sender->avatar ?? 'global/materials/user.png') }}"
                                                alt="" height="40" width="40">
                                        @endif
                                    </div>
                                    <div class="message-body">
                                    ...
                                    @php
                                        $ticket_attachments = $message->attach;
                                    @endphp
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12">
                                            <div class="site-input-groups">
                                                <textarea class="form-textarea" placeholder="{{ __('Write Reply') }}" name="message"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="buttons">
