@php
    $fields = config('setting.virtual_card');
@endphp
    ...
    <div class="site-card">
        ...
        <div class="site-card-body">
            ...
            <div class="site-input-groups row mb-0">
                <label for="" class="col-sm-4 col-label">{{ __('Card Background Image') }}</label>
                <div class="col-sm-8">
                    <div class="site-input-groups">
                        <div class="wrap-custom-file">
                            <input type="file" name="card_bg_image" id="card_bg_image"
                                accept=".gif, .jpg, .png, .svg, .webp" />
                            <label for="card_bg_image" class="file-ok"
                                style="background-image: url( {{ asset(oldSetting('card_bg_image', 'virtual_card')) }} )">
                ...
                <div class="col-sm-8">
                    <div class="site-input-groups">
                        <div class="input-group joint-input">
                            <input type="text" name="card_creation_charge"
                                value="{{ oldSetting('card_creation_charge', 'virtual_card') }}" class="form-control">
                    ...
                    <div class="site-input-groups position-relative">
                        <div class="position-relative">
                            <input type="text" class="box-input"
                                value="{{ oldSetting('card_topup_charge', 'virtual_card') }}" name="card_topup_charge">
                            <div class="prcntcurr">
            ...
            <div class="site-input-groups row mb-0">
                ...
                <div class="col-sm-8">
                    <div class="site-input-groups">
                        <div class="input-group joint-input">
                            <input type="text" name="card_creation_limit"
                                value="{{ oldSetting('card_creation_limit', 'virtual_card') }}" class="form-control">
