...
@section('setting-content')
            ...
            <div class="site-card-header">
                ...
                <div class="card-header-links">
                    <a data-bs-toggle="modal" data-bs-target="#mailConnection" href="javascript:void(0);"
                        class="card-header-link"> <i data-lucide="mail-check"></i> {{ __('Connection Check') }}</a>
                </div>
            </div>
                            ...
                            <div class="form-row row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" class="box-input" name="email_from_name"
                                            value="{{ setting('email_from_name', 'mail') }}" required />
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="email" class="box-input" name="email_from_address"
                                            value="{{ setting('email_from_address', 'mail') }}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                            <div class="site-input-groups">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="mailing_driver" id="smtp"
                                        value="smtp" checked="" />
                            ...
                            <div class="form-row row">
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" class="box-input" name="mail_username"
                                            value="{{ setting('mail_username', 'mail') }}" required="" />
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="site-input-groups">
                                        <label for="" class="box-input-label">{{ __('Mail Password') }}</label>
                                        <input type="password" class="box-input" name="mail_password"
                            ...
                            <div class="form-row row">
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" class="box-input" name="mail_host"
                                            value="{{ setting('mail_host', 'mail') }}" required="" />
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-sm-12">
                                    <div class="site-input-groups">
                                        <label for="" class="box-input-label">{{ __('SMTP Port') }}</label>
                                        <input type="text" class="box-input" name="mail_port"
                                            value="{{ setting('mail_port', 'mail') }}" required="" />
                                    </div>
                                </div>
                                <div class="col-xl-3 col-md-3 col-sm-12">
                                    <div class="site-input-groups">
                                        <label for="" class="box-input-label">{{ __('SMTP Secure') }}</label>
                                        <input type="text" class="box-input" name="mail_secure"
                                            value="{{ setting('mail_secure', 'mail') }}" required="" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="mailConnection" tabindex="-1" aria-labelledby="mailConnectionLabel"
        aria-hidden="true">
