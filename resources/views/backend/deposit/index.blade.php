                    ...
                    <div class="site-tab-bars">
                        <ul>
                            ...
                            @can('automatic-gateway-manage')
                                <li
                                    class="{{ isActive('admin.deposit.method.list', 'auto') . isActive('admin.deposit.method.create', 'auto') . isActive('admin.deposit.method.edit', 'auto') }}">
                            ...
                            @can('manual-gateway-manage')
                                <li
                                    class="{{ isActive('admin.deposit.method.list', 'manual') . isActive('admin.deposit.method.create', 'manual') . isActive('admin.deposit.method.edit', 'manual') }}">
