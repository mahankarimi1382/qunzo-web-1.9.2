                                    ...
                                    <tbody>
                                        @forelse($jobs as $job)
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>{{ $job->last_run_at?->format('d M Y h:i A') ?? '--' }}</strong>
                                                    <br>
                                                ...
                                                <td>
                                                    @can('cron-job-logs')
                                                        <a href="{{ route('admin.cron.jobs.logs', encrypt($job->id)) }}"
                                                            class="round-icon-btn grad-btn" data-bs-toggle="tooltip"
                                                            title="{{ __('Logs') }}"
                                                            data-bs-original-title="{{ __('Logs') }}">
                                                            <i data-lucide="file-cog"></i>
                                                        </a>
                                                    @endcan

                                                    @can('cron-job-run')
                                                        <a href="{{ route('cron.job', ['run_action' => $job->id]) }}"
                                                            class="round-icon-btn blue-btn" data-bs-toggle="tooltip"
                                                            title="{{ __('Run Now') }}"
                                                            data-bs-original-title="{{ __('Run Now') }}">
                                                            <i data-lucide="refresh-ccw"></i>
                                                        </a>
                                                    @endcan

                                                    @can('cron-job-edit')
                                                        <button class="round-icon-btn primary-btn editBtn"
                                                            data-bs-toggle="tooltip" title="{{ __('Edit') }}"
                                                            data-bs-original-title="{{ __('Edit') }}" type="button"
                                                    ...
                                                    @can('cron-job-delete')
                                                        @if ($job->type == 'custom')
                                                            <button class="round-icon-btn red-btn delete-btn"
                                                                data-bs-toggle="tooltip" title="{{ __('Delete') }}"
                                                                data-bs-original-title="{{ __('Delete') }}"
                                                                data-id="{{ encrypt($job->id) }}" type="button">
