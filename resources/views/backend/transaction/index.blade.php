                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Transactions') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                @forelse($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>
                                            {{ formatAmount($transaction->amount, $transaction->currency, true) }}
                                        </td>
                                        <td>{{ formatAmount($transaction->charge, $transaction->currency, true) }}</td>
                                        <td>
