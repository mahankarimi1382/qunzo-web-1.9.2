                        ...
                        <tbody>
                            @forelse($navigations as $navigation)
                                <tr>
                                    ...
                                    <td>
                                        <strong>{{ $navigation->type_name }}</strong>
                                    </td>
                                    ...
                                    @php
                                        $isItHeaderMenu = str_contains($navigation->type_name, 'Header');
                                    @endphp
                                    <td>
                                        @if ($isItHeaderMenu)
                                            <a class="round-icon-btn green-btn"
                                                href="{{ route('admin.navigation.megamenu', $navigation->id) }}"
                                                title="{{ __('Manage Megamenu') }}">
